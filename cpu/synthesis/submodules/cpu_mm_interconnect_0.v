...
module cpu_mm_interconnect_0 (
		...
		output wire [10:0] to_external_bus_bridge_0_avalon_slave_address,     // to_external_bus_bridge_0_avalon_slave.address
	...
	wire  [13:0] to_external_bus_bridge_0_avalon_slave_agent_m0_address;                     // to_external_bus_bridge_0_avalon_slave_agent:m0_address -> to_external_bus_bridge_0_avalon_slave_translator:uav_address
	...
	wire  [70:0] to_external_bus_bridge_0_avalon_slave_agent_rf_source_data;                 // to_external_bus_bridge_0_avalon_slave_agent:rf_source_data -> to_external_bus_bridge_0_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [70:0] to_external_bus_bridge_0_avalon_slave_agent_rsp_fifo_out_data;              // to_external_bus_bridge_0_avalon_slave_agent_rsp_fifo:out_data -> to_external_bus_bridge_0_avalon_slave_agent:rf_sink_data
	...
	wire  [87:0] cmd_mux_002_src_data;                                                       // cmd_mux_002:src_data -> NIOS_debug_mem_slave_agent:cp_data
	...
	wire  [87:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> RAM_s1_agent:cp_data
	...
	wire  [69:0] to_external_bus_bridge_0_avalon_slave_agent_rp_data;                        // to_external_bus_bridge_0_avalon_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [87:0] nios_debug_mem_slave_agent_rp_data;                                         // NIOS_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [87:0] ram_s1_agent_rp_data;                                                       // RAM_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [87:0] router_src_data;                                                            // router:src_data -> NIOS_data_master_limiter:cmd_sink_data
	wire         router_src_ready;                                                           // NIOS_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire   [3:0] router_src_channel;                                                         // router:src_channel -> NIOS_data_master_limiter:cmd_sink_channel
	...
	wire  [87:0] nios_data_master_limiter_cmd_src_data;                                      // NIOS_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire         nios_data_master_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> NIOS_data_master_limiter:cmd_src_ready
	wire   [3:0] nios_data_master_limiter_cmd_src_channel;                                   // NIOS_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [87:0] rsp_mux_src_data;                                                           // rsp_mux:src_data -> NIOS_data_master_limiter:rsp_sink_data
	wire         rsp_mux_src_ready;                                                          // NIOS_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire   [3:0] rsp_mux_src_channel;                                                        // rsp_mux:src_channel -> NIOS_data_master_limiter:rsp_sink_channel
	...
	wire  [87:0] nios_data_master_limiter_rsp_src_data;                                      // NIOS_data_master_limiter:rsp_src_data -> NIOS_data_master_agent:rp_data
	wire         nios_data_master_limiter_rsp_src_ready;                                     // NIOS_data_master_agent:rp_ready -> NIOS_data_master_limiter:rsp_src_ready
	wire   [3:0] nios_data_master_limiter_rsp_src_channel;                                   // NIOS_data_master_limiter:rsp_src_channel -> NIOS_data_master_agent:rp_channel
	...
	wire  [87:0] router_001_src_data;                                                        // router_001:src_data -> NIOS_instruction_master_limiter:cmd_sink_data
	wire         router_001_src_ready;                                                       // NIOS_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire   [3:0] router_001_src_channel;                                                     // router_001:src_channel -> NIOS_instruction_master_limiter:cmd_sink_channel
	...
	wire  [87:0] nios_instruction_master_limiter_cmd_src_data;                               // NIOS_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire   [3:0] nios_instruction_master_limiter_cmd_src_channel;                            // NIOS_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [87:0] rsp_mux_001_src_data;                                                       // rsp_mux_001:src_data -> NIOS_instruction_master_limiter:rsp_sink_data
	wire         rsp_mux_001_src_ready;                                                      // NIOS_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire   [3:0] rsp_mux_001_src_channel;                                                    // rsp_mux_001:src_channel -> NIOS_instruction_master_limiter:rsp_sink_channel
	...
	wire  [87:0] nios_instruction_master_limiter_rsp_src_data;                               // NIOS_instruction_master_limiter:rsp_src_data -> NIOS_instruction_master_agent:rp_data
	...
	wire   [3:0] nios_instruction_master_limiter_rsp_src_channel;                            // NIOS_instruction_master_limiter:rsp_src_channel -> NIOS_instruction_master_agent:rp_channel
	...
	wire  [69:0] to_external_bus_bridge_0_avalon_slave_burst_adapter_source0_data;           // to_external_bus_bridge_0_avalon_slave_burst_adapter:source0_data -> to_external_bus_bridge_0_avalon_slave_agent:cp_data
	...
	wire   [3:0] to_external_bus_bridge_0_avalon_slave_burst_adapter_source0_channel;        // to_external_bus_bridge_0_avalon_slave_burst_adapter:source0_channel -> to_external_bus_bridge_0_avalon_slave_agent:cp_channel
	...
	wire  [69:0] router_003_src_data;                                                        // router_003:src_data -> to_external_bus_bridge_0_avalon_slave_rsp_width_adapter:in_data
	wire         router_003_src_ready;                                                       // to_external_bus_bridge_0_avalon_slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire   [3:0] router_003_src_channel;                                                     // router_003:src_channel -> to_external_bus_bridge_0_avalon_slave_rsp_width_adapter:in_channel
	...
	wire  [87:0] to_external_bus_bridge_0_avalon_slave_rsp_width_adapter_src_data;           // to_external_bus_bridge_0_avalon_slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire   [3:0] to_external_bus_bridge_0_avalon_slave_rsp_width_adapter_src_channel;        // to_external_bus_bridge_0_avalon_slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [87:0] cmd_mux_001_src_data;                                                       // cmd_mux_001:src_data -> to_external_bus_bridge_0_avalon_slave_cmd_width_adapter:in_data
	wire         cmd_mux_001_src_ready;                                                      // to_external_bus_bridge_0_avalon_slave_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                    // cmd_mux_001:src_channel -> to_external_bus_bridge_0_avalon_slave_cmd_width_adapter:in_channel
	...
	wire  [69:0] to_external_bus_bridge_0_avalon_slave_cmd_width_adapter_src_data;           // to_external_bus_bridge_0_avalon_slave_cmd_width_adapter:out_data -> to_external_bus_bridge_0_avalon_slave_burst_adapter:sink0_data
	...
	wire   [3:0] to_external_bus_bridge_0_avalon_slave_cmd_width_adapter_src_channel;        // to_external_bus_bridge_0_avalon_slave_cmd_width_adapter:out_channel -> to_external_bus_bridge_0_avalon_slave_burst_adapter:sink0_channel
	...
	wire   [3:0] nios_data_master_limiter_cmd_valid_data;                                    // NIOS_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [3:0] nios_instruction_master_limiter_cmd_valid_data;                             // NIOS_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	cpu_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_0_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (NIOS_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	cpu_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
